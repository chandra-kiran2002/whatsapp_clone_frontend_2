                ...
                .then(result => {
                    ...
                    var scrollHtml=""
                     for(var i=0;i<result.length;i++){
                        ...
                        if(result[i].count>0){
                        scrollHtml+="<li class='clearfix' name='"+ result[i].ids+"' onclick='chatting(this)'><img src='https://bootdey.com/img/Content/avatar/avatar1.png' alt='avatar'><div class='about'><div class='name'><p style='display:inline'>"+result[i].name+"</p>  <span class='badge badge-primary'>"+result[i].count+"</span></div>   <div class='status'> <i class='fa fa-circle offline'></i> left 7 mins ago </div></div></li>"
                        }
                        else{
                            scrollHtml+="<li class='clearfix' name='"+ result[i].ids+"' onclick='chatting(this)'><img src='https://bootdey.com/img/Content/avatar/avatar1.png' alt='avatar'><div class='about'><div class='name'><p style='display:inline'>"+result[i].name+"</p> <span class='badge badge-primary'></span></div>   <div class='status'> </div><div class='status'> <i class='fa fa-circle offline'></i> left 7 mins ago </div></div></li>"
                        }
                    }
